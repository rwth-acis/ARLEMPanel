...
module.exports = (app) => {
  app.get(config.apiBaseUrl + '/activity', validationMiddleware.validate(), (req, res) => {
    const options = {
  ...
  app.get(config.apiBaseUrl + '/activity/:id', validationMiddleware.validate(), async (req, res) => {
  ...
  app.post(config.apiBaseUrl + '/activity', validationMiddleware.validate(validationRules.activity), (req, res) => {
    var actionIds = []
    activity.create({
      name: req.body.name,
  ...
  app.put(config.apiBaseUrl + '/activity/:id', validationMiddleware.validate(validationRules.activity), (req, res) => {
  ...
  app.get(config.apiBaseUrl + '/activity/:id/action', validationMiddleware.validate(), (req, res) => {
  ...
  app.delete(config.apiBaseUrl + '/activity/:id', validationMiddleware.validate(), (req, res) => {
    activity.find({where: {id: req.params.id}}).then((object) => {
      if (object !== null) {
